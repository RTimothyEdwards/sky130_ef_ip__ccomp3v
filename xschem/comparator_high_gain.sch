...
N 380 -780 420 -780 { lab=VDD}
N 700 -780 740 -780 { lab=VDD}
...
N 900 -670 1140 -670 {
lab=VOUTANALOG}
C {devices/lab_wire.sym} 540 -870 0 1 {name=l1 sig_type=power lab=VDD}
...
C {devices/lab_wire.sym} 740 -780 2 0 {name=l13 sig_type=power lab=VDD}
C {devices/lab_wire.sym} 380 -780 2 1 {name=l15 sig_type=power lab=VDD}
...
C {devices/iopin.sym} 500 -1090 0 0 {name=p5 lab=VDD}
C {devices/iopin.sym} 500 -1050 0 0 {name=p6 lab=VSS}
C {devices/opin.sym} 500 -1000 0 0 {name=p7 lab=VOUT}
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 440 -780 0 1 {name=M6
L=2
W=5
nf=1
mult=2
...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 680 -780 0 0 {name=M7
L=2
W=5
nf=1
mult=2
...
C {devices/iopin.sym} 500 -1130 0 0 {name=p4 lab=DVSS}
