...
S {}
E {}
N 80 -90 320 -90 { lab=#net1}
N 40 -160 120 -160 { lab=#net1}
N 120 -160 120 -90 { lab=#net1}
N 40 -60 40 0 { lab=VSS}
N 40 0 360 0 { lab=VSS}
N 360 -60 360 0 { lab=VSS}
N 360 -520 360 -120 { lab=#net2}
N 80 -450 360 -450 { lab=#net2}
N 40 -550 320 -550 { lab=#net3}
N 40 -550 40 -480 { lab=#net3}
N 40 -580 40 -550 { lab=#net3}
...
N 220 -550 220 -340 { lab=#net3}
N 150 -310 180 -310 { lab=#net1}
N 150 -310 150 -260 { lab=#net1}
N 150 -260 220 -260 { lab=#net1}
N 220 -270 220 -90 { lab=#net1}
N 220 -160 500 -160 { lab=#net1}
N 220 -280 220 -270 { lab=#net1}
